...
const SELECTOR_GROUPS = [
  { label: "🌾 Crop Type", key: "crop", options: CROPS }, { label: "🟫 Soil Type", key: "soil", options: SOIL_TYPES },
  { label: "💧 Irrigation Method", key: "irrigation", options: IRRIGATION }, { label: "🌱 Seed Quality", key: "seed", options: SEED_QUALITY },
];
