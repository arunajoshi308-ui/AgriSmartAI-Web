...
export default function YieldPage() {
  ...
  const calculate = () => {
    ...
    setResult({ crop, acres, estimatedYieldTons: Math.round(totalTons * 100) / 100, estimatedRevenueUSD: Math.round(revenue * 100) / 100, npkRatio: npkRatios[crop] || "100 : 50 : 50 (NPK kg/ha)", recommendations });
  };
